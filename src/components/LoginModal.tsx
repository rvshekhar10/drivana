...
type Step = "input" | "forgot" | "forgot-sent" | "success";
        ...
        >
          ...
          >
            ...
            <div className="p-8">
              ...
              {/* Input Step — Email Login / Register */}
              {step === "input" && (
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={
                        isRegisterMode ? handleEmailRegister : handleEmailLogin
                      }
                      disabled={loading}
                  ...
                  <p className="text-white/30 text-xs mt-6 text-center">
                    ...
                    &{" "}
                    <a href="/privacy" className="text-gold/60 hover:text-gold">
                      Privacy Policy
                    </a>
                  </p>
                </motion.div>
