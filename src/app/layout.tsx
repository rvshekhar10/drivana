        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "You need a valid driving license, Aadhaar card (or any government ID), and a security deposit (₹3,000 for Alto, ₹5,000 for other cars). The process is quick and hassle-free.",
            },
          },
          {
            "@type": "Question",
